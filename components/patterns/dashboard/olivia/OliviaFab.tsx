...
export function OliviaFab({
   ...
   * summary, or personalized suggestions waiting in the zero state) —
   * same purple dot + pulse ring treatment as the nav avatar's
   * oliviaHasNotification (see Nav.tsx). */
